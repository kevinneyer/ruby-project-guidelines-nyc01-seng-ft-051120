...
t1=Teacher.create(user_name: "aa", password:"123", name: "Kelly",subject:"Social Studies")
t2=Teacher.create(user_name: "cc", password:"123", name: "Bob", subject:"Science" )
t3=Teacher.create(user_name: "ee", password:"123", name: "Charlie", subject:"Computer" )
t4=Teacher.create(user_name: "ff", password:"123", name: "Chris", subject:"Music" )
t5=Teacher.create(user_name: "gg", password:"123", name: "Emmy", subject:"Computer")
t6=Teacher.create(user_name: "hh", password:"123", name: "Diana", subject:"English")

s0=Student.create(name: "Josh", grade: 12, gpa: 3.2, user_name: "bb", password: "123")
s1=Student.create(name: "Josh2", grade: 1, gpa: 3.7, user_name: "ii", password: "123")
s2=Student.create(name: "Kevin", grade: 2, gpa: 3.1, user_name: "jj", password: "123")
s3=Student.create(name: "Lily", grade: 11, gpa: 2.2, user_name: "kk", password: "123")
s4=Student.create(name: "Asha", grade: 10, gpa: 1.2, user_name: "ll", password: "123")
s5=Student.create(name: "Pinto", grade: 9, gpa: 3.5, user_name: "mm", password: "123")
s6=Student.create(name: "Harry", grade: 8, gpa: 3.9, user_name: "nn", password: "123")
s7=Student.create(name: "Jabish", grade: 7, gpa: 3.9, user_name: "oo", password: "123")
...
Classroom.create(student_id: s4.id, teacher_id: t0.id , session_id: se1.id)
Classroom.create(student_id: s3.id, teacher_id: t0.id, session_id: se2.id)
...
Classroom.create(student_id: s0.id, teacher_id: t4.id, session_id: se1.id)
Classroom.create(student_id: s4.id, teacher_id: t0.id , session_id: se5.id)
Classroom.create(student_id: s5.id, teacher_id: t1.id, session_id: se0.id)
Classroom.create(student_id: s2.id, teacher_id: t2.id, session_id: se1.id)
Classroom.create(student_id: s1.id, teacher_id: t4.id, session_id: se1.id)
